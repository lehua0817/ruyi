...
public class TasksCompletedDistanceView extends View {
	// 画实心圆的画笔
	...
	public TasksCompletedDistanceView(Context context, AttributeSet attrs) {
		super(context, attrs);
		// 获取自定义的属性
	...
	private void initVariable() {
		...
		mRingPaint.setColor(getResources().getColor(R.color.distanc_data_bg));
		...
		mRingPaint2.setColor(getResources().getColor(R.color.distance_color));
